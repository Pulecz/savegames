...
See mayor_log.md for city progress.
...
see file stable.xml and copy it to c:\Users\${user}\AppData\Local\Colossal Order\Cities_Skylines\Addons\Mods\ModsList\ModsList_savefiles\
after subscribing to all mods (not sure how that behaves since I always use steam with synced mods) the save **should** load
